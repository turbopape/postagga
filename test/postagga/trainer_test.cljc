...
(deftest process-annotated-sentence-test
  ...
  (is (= {:states #{nil}, :transitions {}, :emissions {[nil nil] 1}, :init-state nil} (process-annotated-sentence nil))) ; TODO: should be empty!
  (is (= {:states #{nil}, :transitions {}, :emissions {[nil nil] 1}, :init-state nil} (process-annotated-sentence [])))  ; TODO: should be empty!
